  ...
  Widget _buildSectionTitle(IconData icon, String title) {
    return Row(
      children: [
        ...
        Text(title, style: GoogleFonts.inter(fontSize: 14, fontWeight: FontWeight.bold, color: AppColors.primary)),
      ],
    );
  }
          ...
          Expanded(
            child: SingleChildScrollView(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  _buildSectionTitle(Icons.info_outline, 'Informasi Rapat'),
                  ...
                  Row(
                    children: [
                      ...
                      const SizedBox(width: 16),
                      Expanded(
                        child: _buildTextField('Peserta', _pesertaController, hint: 'Siapa saja yang hadir...'),
                      ),
                    ],
                  ),
                  ...
                  _buildSectionTitle(Icons.fact_check_outlined, 'Evaluasi'),
                  const SizedBox(height: 16),
                  _buildTextField('Topik / Agenda', _topikController, required: true, maxLines: 2, hint: 'Topik rapat...'),
                  const SizedBox(height: 16),
                  _buildTextField('Kendala', _kendalaController, maxLines: 2, hint: 'Kendala yang dibahas...'),
                  const SizedBox(height: 16),
                  _buildTextField('Hasil Evaluasi / Kesimpulan', _hasilEvaluasiController, required: true, maxLines: 3, hint: 'Kesimpulan hasil rapat...'),
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        Row(
                          children: [
                            Icon(Icons.trending_up, size: 18, color: Colors.green.shade700),
                            const SizedBox(width: 8),
                            Text('Tindak Lanjut & Notulen', style: GoogleFonts.inter(fontSize: 14, fontWeight: FontWeight.bold, color: Colors.green.shade800)),
                          ],
                        ),
                        const SizedBox(height: 16),
                        ...
                        Row(
                          children: [
                            Expanded(
                              flex: 3,
                              child: _buildTextField('PIC', _picController, hint: 'Penanggung Jawab'),
                            ),
                            const SizedBox(width: 12),
                            Expanded(
                              flex: 3,
                              child: _buildTextField('Tenggat Waktu', _tenggatController, readOnly: true, onTap: () => _selectDate(_tenggatController), hint: 'mm/dd/yyyy'),
                            ),
                            const SizedBox(width: 12),
                            Expanded(
                              flex: 2,
                              child: Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Text('Status', style: GoogleFonts.inter(fontSize: 12, fontWeight: FontWeight.w600, color: AppColors.textDark)),
                                  const SizedBox(height: 8),
                                  Container(
                                    height: 48,
                        ...
                        const SizedBox(height: 16),
                        Text('File Notulen (Opsional)', style: GoogleFonts.inter(fontSize: 12, fontWeight: FontWeight.w600, color: AppColors.textDark)),
                        const SizedBox(height: 8),
                        Container(
                          decoration: BoxDecoration(
                            color: Colors.white,
                        ...
                        const SizedBox(height: 8),
                        Text('Format: PDF, Word, atau Gambar (Max. 5MB)', style: GoogleFonts.inter(fontSize: 10, color: Colors.grey.shade500)),
                      ],
                    ),
                  ),
                ],
