                ...
                : _error.isNotEmpty
                    ...
                    : RefreshIndicator(
                        ...
                        child: ListView.builder(
                          ...
                          itemCount: _jenisBonusList.length,
                          itemBuilder: (context, index) {
                            final jenisBonus = _jenisBonusList[index];
  ...
  Widget _buildItem(JenisBonusModel jenisBonus) {
    return Container(
      ...
      child: ListTile(
        ...
        title: Text(jenisBonus.namaBonus, style: GoogleFonts.inter(fontWeight: FontWeight.bold, color: AppColors.textDark)),
        trailing: Row(
