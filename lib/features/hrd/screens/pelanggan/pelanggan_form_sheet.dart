...
class PelangganFormSheet extends StatefulWidget {
  final PelangganHrdModel? pelanggan;
  final List<CabangModel>? cabangs;

  const PelangganFormSheet({
    super.key,
    this.pelanggan,
    this.cabangs,
  });
  ...
  @override
  State<PelangganFormSheet> createState() => _PelangganFormSheetState();
}

class _PelangganFormSheetState extends State<PelangganFormSheet> {
  ...
  void initState() {
    ...
    if (widget.pelanggan != null) {
      final statusVal = widget.pelanggan!.status.toLowerCase();
  ...
  Future<void> _submit() async {
    ...
    if (_selectedCabang == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Pilih cabang operasional terlebih dahulu'),
    ...
    try {
      final data = {
        'nama_pelanggan': _namaCtrl.text.trim(),
        'no_wa': _noWaCtrl.text.trim().isEmpty ? null : _noWaCtrl.text.trim(),
          ...
          SnackBar(
            content: Text(
              widget.pelanggan == null
                  ? 'Pelanggan "${_namaCtrl.text}" berhasil ditambahkan'
                  : 'Data pelanggan "${_namaCtrl.text}" berhasil diperbarui',
            ),
              ...
              Row(
                children: [
                  Container(
                    ...
                    child: Icon(
                      isEdit ? Icons.person_search_rounded : Icons.person_add_alt_1_rounded,
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          isEdit ? 'Perbarui informasi kontak & alamat pelanggan' : 'Daftarkan pelanggan baru ke basis data',
                          style: GoogleFonts.inter(
                            fontSize: 12,
                    ...
                    children: [
                      ...
                      TextFormField(
                        ...
                        decoration: InputDecoration(
                          hintText: 'Contoh: Bapak Ahmad Fauzi',
                        ...
                        validator: (val) {
                          if (val == null || val.trim().isEmpty) return 'Nama pelanggan wajib diisi';
                          return null;
                        },
                      ),
                      ...
                      TextFormField(
                        ...
                        decoration: InputDecoration(
                          ...
                          hintStyle: GoogleFonts.inter(color: const Color(0xFF94A3B8), fontSize: 13),
                          prefixIcon: const Icon(Icons.phone_outlined, color: Color(0xFF16A34A), size: 19),
                          filled: true,
                          fillColor: const Color(0xFFF8FAFC),
                          border: OutlineInputBorder(
                            borderRadius: BorderRadius.circular(12),
                      ...
                      TextFormField(
                        ...
                        style: GoogleFonts.inter(fontSize: 13.5, fontWeight: FontWeight.w500, color: const Color(0xFF0F172A)),
                        decoration: InputDecoration(
                          hintText: 'Masukkan nama jalan, nomor rumah, perumahan, kelurahan...',
                          hintStyle: GoogleFonts.inter(color: const Color(0xFF94A3B8), fontSize: 13),
                          prefixIcon: const Padding(
                            padding: EdgeInsets.only(bottom: 24),
                            child: Icon(Icons.location_on_outlined, color: Color(0xFFEF4444), size: 19),
                          ),
                          filled: true,
                          fillColor: const Color(0xFFF8FAFC),
                          border: OutlineInputBorder(
                      ...
                      TextFormField(
                        ...
                        style: GoogleFonts.inter(fontSize: 13.5, fontWeight: FontWeight.w500, color: const Color(0xFF0F172A)),
                        decoration: InputDecoration(
                          hintText: 'Contoh: Pelanggan langganan, request cleaner khusus...',
                          hintStyle: GoogleFonts.inter(color: const Color(0xFF94A3B8), fontSize: 13),
                          prefixIcon: const Padding(
                            padding: EdgeInsets.only(bottom: 24),
                            child: Icon(Icons.notes_rounded, color: Color(0xFF64748B), size: 19),
                          ),
                          filled: true,
                          fillColor: const Color(0xFFF8FAFC),
                          border: OutlineInputBorder(
