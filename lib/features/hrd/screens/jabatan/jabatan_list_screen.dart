                ...
                : _error.isNotEmpty
                    ...
                    : RefreshIndicator(
                        ...
                        child: ListView.builder(
                          ...
                          itemCount: _jabatans.length,
                          itemBuilder: (context, index) {
                            final jabatan = _jabatans[index];
  ...
  Widget _buildItem(JabatanModel jabatan) {
    return Container(
      ...
      child: ListTile(
        ...
        title: Text(jabatan.namaJabatan, style: GoogleFonts.inter(fontWeight: FontWeight.bold, color: AppColors.textDark)),
        subtitle: Text(jabatan.cabang?.namaCabang ?? 'Semua Cabang', style: GoogleFonts.inter(fontSize: 12, color: AppColors.textMuted)),
        trailing: Row(
