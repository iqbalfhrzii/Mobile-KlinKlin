...
class _FinanceCancelListScreenState extends State<FinanceCancelListScreen> with WidgetsBindingObserver {
  ...
  void _startTimer() {
    ...
    _refreshTimer = Timer.periodic(const Duration(minutes: 3), (_) => _fetchOrders(silent: true));
  }
