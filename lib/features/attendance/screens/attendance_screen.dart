...
class _AttendanceScreenState extends State<AttendanceScreen> {
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              'Tidak ada data check-in maupun check-out pada hari kerja ini.',
                              style: GoogleFonts.inter(
                                fontSize: 11.5,
                          ...
                          children: [
                            ...
                            Text(
                              status.contains('Libur')
                                  ? 'Karyawan memiliki jadwal libur pada tanggal ini sehingga tidak wajib absen.'
                                  : 'Karyawan memiliki izin / cuti yang telah disetujui pada tanggal ini.',
                              style: GoogleFonts.inter(
                                fontSize: 11.5,
                                color: AppColors.textDark,
                              ),
  ...
  Widget _buildDetailSession({
    ...
    final timeFormatted = _parseTimeOnly(item.time);
    final distance = item.distanceMeter;
