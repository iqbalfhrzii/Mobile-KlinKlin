...
class GajiKaryawanModel {
  ...
  GajiKaryawanModel({
    ...
    this.gajiPokok = 0,
    this.gajiPokokHarian = 0,
    this.bonusBulanan = 0,
    this.tunjanganKos = 0,
    this.tunjanganKerja = 0,
    this.premiBpjs = 0,
    this.kasbon = 0,
    this.potonganTidakAbsen = 0,
    this.potonganKeterlambatan = 0,
    this.potonganAbsen = 0,
    this.bpjsKetenagakerjaan = 0,
    this.potonganLainnya = 0,
    this.keteranganPotonganLainnya,
    this.bonusReview = 0,
    this.bonusTanggalMerah = 0,
    this.totalKilometer = 0,
    this.totalDeepclean = 0,
    this.totalSalon = 0,
    this.totalTips = 0,
    this.totalParkir = 0,
    this.totalLembur = 0,
    this.totalUangMakan = 0,
    this.totalBonusLainnya = 0,
    this.totalBonus = 0,
    this.totalPotongan = 0,
    this.takeHomePay = 0,
    this.totalGajiDiterima = 0,
    this.karyawan,
  });
