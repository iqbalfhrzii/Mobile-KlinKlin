...
void main() {
  var file = File('c:\\Users\\HP VICTUS\\Documents\\Mobile\\lib\\features\\orders\\screens\\order_detail_screen.dart');
  var content = file.readAsStringSync();
  
  var startIndex = content.indexOf('  Future<void> _showAturLayananSingleModal(');
  var endIndex = content.indexOf('  Future<void> _showAssignCleanerModal(');
  
  if (startIndex != -1 && endIndex != -1) {
    var newModal = r'''  Future<void> _showAturQtyHargaDropdownModal(OrderModel o) async {
...
''';
    ...
    var newContent = content.substring(0, startIndex) + newModal + content.substring(endIndex);
    file.writeAsStringSync(newContent);
    print('SUCCESS');
  } else {
    print('FAILED TO FIND MARKERS: $startIndex $endIndex');
  }
}
